document.getElementById("formParciales").addEventListener("submit", function(e) {
    e.preventDefault();
    const datos = {
        profesor_id: document.getElementById("profesor_id").value,
        alumno_id: document.getElementById("alumno_id").value,
        materia: document.getElementById("materia").value,
        parcial: document.getElementById("parcial").value,
        calificacion: document.getElementById("calificacion").value
    };
    fetch("../../backend/calificaciones-parciales/CalificacionesParciales.php", {
        method: "POST",
